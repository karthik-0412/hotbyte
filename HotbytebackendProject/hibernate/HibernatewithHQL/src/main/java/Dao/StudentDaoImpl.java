...
public class StudentDaoImpl implements StudentDao {
    ...
    @Override
    public void nupdateByRollNo(String name,int roll){
        Session session=factory.openSession();
        Transaction txt=session.beginTransaction();
    ...
    @Override
    public void nremoveByRoll(int rno) {
        Session session=factory.openSession();
    ...
    @Override
    public void nameremoveByRoll(int rno) {
        Session session=factory.openSession();
...
//        NativeQuery<Student> query=session.createNativeQuery("select * from Student", Student.class);
    ...
    @Override
    public void namesearchByName(String name) {
        Session session=factory.openSession();
        Transaction txt = session.beginTransaction();
